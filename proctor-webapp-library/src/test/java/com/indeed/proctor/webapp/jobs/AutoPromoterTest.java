...
public class AutoPromoterTest {
        ...
        public void testAllocationOnlyChangeDetection() {
            {
                ...
                final TestDefinition testDefinitionOne =
                        createTestDefinition("testbuck:0", rangeOne);
                final TestDefinition testDefinitionTwo =
                        createTestDefinition("testbuck:0", rangeTwo);
                assertTrue(
                        AutoPromoter.isAllocationOnlyChange(testDefinitionOne, testDefinitionTwo));
            }
            { // different amounts of buckets
                ...
                final TestDefinition testDefinitionOne =
                        createTestDefinition("testbuck:0", rangeOne);
                final TestDefinition testDefinitionTwo =
                        createTestDefinition("testbuck:0,control:1", rangeTwo);
                assertFalse(
                        AutoPromoter.isAllocationOnlyChange(testDefinitionOne, testDefinitionTwo));
            }
            { // different buckets
                ...
                final double[] rangeTwo = {.5, .5};
                final TestDefinition testDefinitionOne =
                        createTestDefinition("testbuck:0,control:2", rangeOne);
                final TestDefinition testDefinitionTwo =
                        createTestDefinition("testbuck:0,control:1", rangeTwo);
                assertFalse(
                        AutoPromoter.isAllocationOnlyChange(testDefinitionOne, testDefinitionTwo));
            ...
            { // different testtypes
                ...
                final double[] rangeTwo = {.5, .5};
                final TestDefinition testDefinitionOne =
                        createTestDefinition("testbuck:0,control:2", TestType.RANDOM, rangeOne);
                final TestDefinition testDefinitionTwo =
                        createTestDefinition(
                                "testbuck:0,control:2", TestType.EMAIL_ADDRESS, rangeTwo);
                assertFalse(
                        AutoPromoter.isAllocationOnlyChange(testDefinitionOne, testDefinitionTwo));
            }
            { // testing different salts
                ...
                final TestDefinition testDefinitionOne =
                        createTestDefinition(
                                "testbuck:0,control:2", TestType.RANDOM, "salt1", rangeOne);
                final TestDefinition testDefinitionTwo =
                        createTestDefinition(
                                "testbuck:0,control:2", TestType.RANDOM, "salt2", rangeTwo);
                assertFalse(
                        AutoPromoter.isAllocationOnlyChange(testDefinitionOne, testDefinitionTwo));
            }
            { // testing 0 to greater allocation
                ...
                final TestDefinition testDefinitionOne =
                        createTestDefinition("testbuck:0,control:2", rangeOne);
                final TestDefinition testDefinitionTwo =
                        createTestDefinition("testbuck:0,control:2", rangeTwo);
                assertFalse(
                        AutoPromoter.isAllocationOnlyChange(testDefinitionOne, testDefinitionTwo));
            }
            ...
            { // testing null payloads
                ...
                final TestDefinition testDefinitionOne =
                        createTestDefinition(
                                "testbuck:0,control:2", TestType.RANDOM, "salt1", rangeOne, null);
                final TestDefinition testDefinitionTwo =
                        createTestDefinition(
                                "testbuck:0,control:2",
                                TestType.RANDOM,
        ...
        public void testIsAllInactiveTest() {
            { // testing isAllInactiveTest is false
                ...
                final TestDefinition testDefinition =
                        createTestDefinition(
                                "control:0,test:1", range, ImmutableList.of("#A1234", "#C1"));
            ...
            { // testing isAllInactiveTest is false
                ...
                final TestDefinition testDefinition =
                        createTestDefinition(
                                "inactive:-1,control:0", range, ImmutableList.of("#A1234", "#C1"));
            ...
            { // testing isAllInactiveTest is false
                ...
                final TestDefinition testDefinition =
                        createTestDefinition(
                                "inactive:0", range, ImmutableList.of("#A1234", "#C1"));
            ...
            { // testing isAllInactiveTest is false
                ...
                final TestDefinition testDefinition =
                        createTestDefinition(
                                "evitcani:-1", range, ImmutableList.of("#A1234", "#C1"));
            ...
            { // testing isAllInactiveTest is true
                ...
                final TestDefinition testDefinition =
                        createTestDefinition(
                                "inactive:-1", range, ImmutableList.of("#A1234", "#C1"));
            ...
            { // testing isAllInactiveTest is true
                ...
                final TestDefinition testDefinition =
                        createTestDefinition(
                                "disabled:-1", range, ImmutableList.of("#A1234", "#C1"));
    ...
    public static class TestAutoPromoterInstanceMethod {
        @Mock private ProctorStore trunkStore;
        @Mock private ProctorStore qaStore;
        @Mock private ProctorStore productionStore;
        @Mock private ProctorPromoter proctorPromoter;
        @Mock private BackgroundJob<Void> backgroundJob;
        @Mock private EditAndPromoteJob editAndPromoteJob;
        ...
        private static final Revision PREVIOUS_VERSION =
                new Revision(PREVIOUS_REVISION, null, null, null);
        private static final Revision TRUNK_VERSION =
                new Revision(TRUNK_REVISION, null, null, null);
        ...
        public void setUp() throws StoreException {
            ...
            autoPromoter = spy(new AutoPromoter(editAndPromoteJob));

            // for getCurrentVersion
            when(trunkStore.getHistory(TEST_NAME, 0, 1))
                    .thenReturn(ImmutableList.of(TRUNK_VERSION));
        ...
        private void resetEditAndPromoteMock() {
            ...
            when(editAndPromoteJob.determineStoreFromEnvironment(Environment.WORKING))
                    .thenReturn(trunkStore);
            when(editAndPromoteJob.determineStoreFromEnvironment(Environment.QA))
                    .thenReturn(qaStore);
            when(editAndPromoteJob.determineStoreFromEnvironment(Environment.PRODUCTION))
                    .thenReturn(productionStore);
        }
        ...
        private void mockDoPromoteInternal(
                ...
                throws Exception {
            final Environment destEnvironment =
                    isPromoteToQa ? Environment.QA : Environment.PRODUCTION;

            if (isSuccess) {
                Mockito.doReturn(true)
                        .when(editAndPromoteJob)
                        .doPromoteInternal(
                                TEST_NAME,
                                USERNAME,
                                PASSWORD,
                ...
                Mockito.doThrow(new IllegalArgumentException("invalid"))
                        .when(editAndPromoteJob)
                        .doPromoteInternal(
                                TEST_NAME,
                                USERNAME,
        ...
        public void testDoPromoteTestToQaAndProd() throws Exception {
            { // testing existingTestDefinition is null and test is active
                ...
                final TestDefinition testDefinitionToUpdate =
                        createTestDefinition("testbuck:0", range);
                ...
                assertThatThrownBy(
                                () ->
                                        autoPromoter.doPromoteTestToQaAndProd(
                                                TEST_NAME,
                                                USERNAME,
                                                PASSWORD,
                                                AUTHOR,
            ...
            { // testing existingTestDefinition is null and test is 100% inactive
                ...
                final double[] range = {1.0};
                final TestDefinition testDefinitionToUpdate =
                        createTestDefinition("inactive:-1", range);
                final TestDefinition existingTestDefinition = null;
                doNothing().when(backgroundJob).log(anyString());
                doNothing()
                        .when(autoPromoter)
                        .doPromoteNewlyCreatedInactiveTestToQaAndProd(
                                TEST_NAME,
                                USERNAME,
                                PASSWORD,
                                AUTHOR,
            ...
            { // testing existingTestDefinition is not null\resetEditAndPromoteMock();
                ...
                final TestDefinition testDefinitionToUpdate =
                        createTestDefinition("control:0,active:1", rangeOne);
                final TestDefinition existingTestDefinition =
                        createTestDefinition("control:0,active:1", rangeTwo);
                doNothing().when(backgroundJob).log(anyString());
                doNothing()
                        .when(autoPromoter)
                        .doPromoteExistingTestToQaAndProd(
                                TEST_NAME,
                                USERNAME,
                                PASSWORD,
                                AUTHOR,
        ...
        public void testDoPromoteNewlyCreatedInactiveTestToQaAndProd() throws Exception {
            { // testing promoting QA fails
                ...
                assertThatThrownBy(
                                () ->
                                        autoPromoter.doPromoteNewlyCreatedInactiveTestToQaAndProd(
                                                TEST_NAME,
                                                USERNAME,
                                                PASSWORD,
                                                AUTHOR,
                ...
                verify(editAndPromoteJob)
                        .doPromoteInternal(
                                ...
                                backgroundJob,
                                true);
                verify(editAndPromoteJob, never())
                        .doPromoteInternal(
                                TEST_NAME,
                                USERNAME,
                                PASSWORD,
        ...
        public void testDoPromoteExistingTestToQaAndProd() throws Exception {
            { // testing isAllocationOnlyChange is false
                ...
                final TestDefinition existingTestDefinition =
                        createTestDefinition("testbuck:0,control:1", rangeTwo);
                Mockito.when(qaStore.getHistory(TEST_NAME, 0, 1))
                        .thenReturn(
                ...
                assertThatThrownBy(
                                () ->
                                        autoPromoter.doPromoteExistingTestToQaAndProd(
                                                TEST_NAME,
                                                USERNAME,
                                                PASSWORD,
                                                AUTHOR,
            ...
            { // testing isQAPromotable is false
                ...
                final TestDefinition testDefinitionToUpdate =
                        createTestDefinition("testbuck:0,control:1", rangeOne);
                final TestDefinition existingTestDefinition =
                        createTestDefinition("testbuck:0,control:1", rangeTwo);
                final TestDefinition existingQaTestDefinition =
                        createTestDefinition("testbuck:0,control:1,testbuck2:2", rangeThree);
                ...
                when(qaStore.getCurrentTestDefinition(TEST_NAME))
                        .thenReturn(existingQaTestDefinition);
            ...
            { // testing promoting QA fails
                ...
                when(qaStore.getCurrentTestDefinition(TEST_NAME))
                        .thenReturn(existingTestDefinition);
            ...
            { // testing promoting QA succeeds
                ...
                Mockito.when(qaStore.getHistory(TEST_NAME, 0, 1))
                        .thenReturn(
                                Collections.singletonList(
                                        new Revision(QA_REVISION, null, null, "foo message")));
                final TestDefinition existingProdTestDefinition =
                        createTestDefinition("testbuck:0,control:1", rangeTwo);
                existingProdTestDefinition.setVersion(PROD_REVISION);
                Mockito.when(productionStore.getHistory(TEST_NAME, 0, 1))
                        .thenReturn(
                                Collections.singletonList(
                ...
                when(qaStore.getCurrentTestDefinition(TEST_NAME))
                        .thenReturn(existingQaTestDefinition);
                when(productionStore.getCurrentTestDefinition(TEST_NAME))
                        .thenReturn(existingProdTestDefinition);
        ...
        public void testDoPromoteTestToEnvSuccess() throws Exception {
            ...
            { // Succeed to promote to Prod
                assertDoPromoteTestToEnvironment(
                        Environment.PRODUCTION, PROD_REVISION, productionStore);
            }
        }

        @Test
        public void testDoPromoteTestToEnvironmentWithoutIsAllocationOnlyChangeValidation()
                throws Exception {
            // Arrange
            final double[] rangeOne = {.7, .3};
            ...
            final TestDefinition testDefinitionToUpdate =
                    createTestDefinition("testbuck:0,control:1", rangeOne);
            final TestDefinition existingTestDefinition =
                    createTestDefinition("testbuck2:0,control:1", rangeTwo);
            ...
            // Act
            autoPromoter.doPromoteTestToEnvironment(
                    Environment.QA,
                    TEST_NAME,
                    USERNAME,
                    PASSWORD,
        ...
        private void assertDoPromoteTestToEnvironment(
            ...
            doNothing().when(backgroundJob).log(anyString());
            Mockito.when(targetStore.getHistory(TEST_NAME, 0, 1))
                    .thenReturn(
                            Collections.singletonList(
                                    new Revision(targetRevision, null, null, "foo message")));
            when(targetStore.getCurrentTestDefinition(TEST_NAME))
                    .thenReturn(existingTestDefinition);
            Mockito.when(targetStore.getCurrentTestDefinition(TEST_NAME))
                    .thenReturn(existingTestDefinition);
