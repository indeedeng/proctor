...
public class GitProctorStoreFactoryTest {
    ...
    @Mock private ProctorStore proctorStore;
    ...
    public void testCreateStoreWithoutGlobalCache() throws IOException {
        final GitProctorStoreFactory gitProctorStoreFactoryWithoutGlobalCache =
                createGitProctorStoreFactory(null);
        final ProctorStore store =
                gitProctorStoreFactoryWithoutGlobalCache.createStoreWithGlobalCache(
                        "trunk", proctorStore);
    ...
    public void testCreateStoreWithGlobalCache() {
        final ProctorStore store =
                gitProctorStoreFactory.createStoreWithGlobalCache("trunk", proctorStore);
    ...
    private GitProctorStoreFactory createGitProctorStoreFactory(
            final GlobalCacheStore globalCacheStore) throws IOException {
