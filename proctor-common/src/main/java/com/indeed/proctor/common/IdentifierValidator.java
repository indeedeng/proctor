 ...
 * {@link Proctor} won't assign any bucket for the identifier and test type when it's classified as invalid.
 * An example case to valid against is a dummy account id that indicates the user is logged out.
 */
public interface IdentifierValidator {
    ...
    class Noop implements IdentifierValidator {
        @Override
        public boolean validate(@Nonnull final TestType testType, @Nonnull final String identifier) {
            return true;
        }
    }
}
