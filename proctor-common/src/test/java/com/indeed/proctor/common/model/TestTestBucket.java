...
public class TestTestBucket {
    ...
    public void testSerialize() throws JsonProcessingException {
        final String expected =
                "{" + "\"name\":\"grp1\"," + "\"value\":1," + "\"description\":\"group 1\"" + "}";

        final String actual =
                serialize(
                        TestBucket.builder().name("grp1").value(1).description("group 1").build());
    ...
    public void testSerializeAndDeserialize() throws IOException {
        ...
        final TestBucket converted = deserialize(serialize(bucket));
    ...
    public void testBuilder() {
        ...
        final TestBucket expected = new TestBucket("name", 10, "desc", payload);
    ...
    public void testFullEquals() {
        ...
        assertTrue(
                new TestBucket("foo", 1, "d1", p1)
                        .fullEquals(new TestBucket("foo", 1, "d1", new Payload("p1String"))));
        assertFalse(
                new TestBucket("foo", 1, "d1", p1)
                        .fullEquals(new TestBucket("foo", 1, "d1", new Payload(0.4))));
    }
    ...
    private static TestBucket deserialize(final String json) throws IOException {
        return new ObjectMapper().readValue(json, TestBucket.class);
    }
}
