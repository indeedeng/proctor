...
public class TestSerializers {
    ...
    public void testTestDefiniton() throws IOException {
        doTest(EXAMPLE_TEST_DEFINITION, Serializers.lenient());
    }
    ...
    public void testSubruleTestDefiniton() throws IOException {
        ...
        doTest(SUBRULE_TEST_DEFINITION, Serializers.lenient());
    }

    @Test
    public void testUnrecognizedFieldsTestDefinition() throws Exception {
        // Expect no error and all valid fields returned correctly.
        doTest(UNRECOGNIZED_FIELDS_TEST_DEFINITION, Serializers.lenient());

        try {
            doTest(UNRECOGNIZED_FIELDS_TEST_DEFINITION, Serializers.strict());
    ...
    private void doTest(final String resourceName, final ObjectMapper mapper) throws IOException {
