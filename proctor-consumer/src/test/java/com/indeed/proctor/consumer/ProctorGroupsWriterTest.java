...
public class ProctorGroupsWriterTest {
    ...
    private static final Map<String, TestBucket> BUCKETS = new ImmutableSortedMap.Builder<String, TestBucket>(Ordering.natural())
            ...
            .build();
    private static final Map<String, Allocation> ALLOCATIONS = new ImmutableSortedMap.Builder<String, Allocation>(Ordering.natural())
    ...
    private static final Map<String, ConsumableTestDefinition> DEFINITIONS = ImmutableMap.<String, ConsumableTestDefinition>builder()
    ...
    private static final ProctorResult PROCTOR_RESULT = new ProctorResult(null, BUCKETS, ALLOCATIONS, DEFINITIONS);
    ...
    public void testCustomWriter() {
        final ProctorGroupsWriter writerWithAllocIds = new ProctorGroupsWriter.Builder(TestGroupFormatter.WITH_ALLOC_ID)
    ...
    public void testWriterWithCustomFilter() {
        ...
        assertThat(new ProctorGroupsWriter.Builder(TestGroupFormatter.WITH_ALLOC_ID).
