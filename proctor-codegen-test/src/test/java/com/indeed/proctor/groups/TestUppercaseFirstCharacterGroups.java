...
/**
 * Test to ensure that Proctor tests that start with an uppercase character retain an unnormalized
 * name in the generated groups class.
 */
public class TestUppercaseFirstCharacterGroups {
    ...
    public void testUppercaseFirstCharacter() {
        Assert.assertEquals(
                "Uppercase_first_character_test", UPPERCASE_FIRST_CHARACTER_TEST.getName());
    }
}
