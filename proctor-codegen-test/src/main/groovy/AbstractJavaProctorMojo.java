...
/**
 * A Gradle task that can combine multiple Proctor specifications and generate a Java file.
 *
 * @author andrewk
 */
abstract class AbstractJavaProctorMojo extends AbstractProctorGradleTask {
